<template>
  <div class="flex h-screen w-full m-0 p-0 overflow-hidden bg-base-100">
    <div
      class="flex w-full lg:w-1/2 flex-col justify-between p-8 xl:p-24 bg-base-100"
    >
      <div class="text-lg font-medium opacity-50">Project-x</div>
    ...
    <div
      class="hidden lg:flex lg:w-1/2 bg-[#1a1c23] relative items-center justify-center overflow-hidden"
    >
      <img
